    ...
    >
      ...
      async function loadFromLocalStorage() {
        ...
        if (raw) {
          ...
          renderItinerary();
          for (let seg of segments) {
            if (!hasSavedCoordinates(seg)) await updateSegmentCoordinates(seg);
          }
          renderItinerary();
          await drawAllRoutes();
          setTimeout(() => {
